...
"E:\Games\SteamLibrary\steamapps\common\Factorio\bin\x64\factorio.exe" --start-server %save% -c %config% --server-settings %settings% --use-server-whitelist true --server-whitelist %whitelist% --map-settings %mapsettings% --map-gen-settings %mapgetnsettings%
